      ...
      <div className="container mx-auto px-2 py-2 md:px-6 md:py-1">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            />
            <span className="text-3xl md:text-3xl font-bold text-white font-poppins">Webworks</span>
          </button>
            ...
            {!loading && (
              <>
                ...
                <button
                  ...
                  className="bg-orange-500 text-white px-8 py-3 text-lg font-semibold rounded-lg hover:bg-orange-600 transition-colors"
                >
                  Get Started
                </button>
              </>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-slate-900/95 backdrop-blur-md border-b border-slate-800">
            <nav className="flex flex-col py-3 px-4 space-y-3">
              <button
                onClick={() => scrollToSection('hero')}
                className="text-lg text-gray-300 hover:text-white transition-colors text-left font-medium"
              >
                Home
              </button>
              <button
              ...
              {!loading && (
                <>
                  ...
                  <button
                    onClick={() => scrollToSection('contact')}
                    className="bg-orange-500 text-white px-8 py-3 text-lg font-semibold rounded-lg hover:bg-orange-600 transition-colors text-left"
                  >
                    Get Started
                  </button>
                </>
