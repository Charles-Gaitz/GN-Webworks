...
const Partnership = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      position: "Founder",import React, { useState, useEffect } from 'react';
import {
  ChevronLeft,
  ChevronRight,
  Star,
...
const Partnership = () => {
  ...
  const coreValues = [
    ...
    },
    {
      ...
      description:
        'Understanding business challenges from firsthand entrepreneurial experience.',
    },
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            A professional website development team with a unique
            entrepreneurial perspective, dedicated to transforming businesses
        ...
        <div className="bg-slate-900/50 rounded-2xl p-8 md:p-12 border border-slate-700 mb-16">
          <div className="max-w-4xl mx-auto">
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                Since 2022, we've specialized in creating, scaling, and
                revitalizing websites that elevate brands and drive measurable
                growth. But our journey began differently—with entrepreneurial
                experience that gives us unique insight into business
                challenges.
              </p>
              <p>
                Drawing from our experience as system engineers and
                entreprenures, we understand firsthand the challenges businesses
                face in the digital landscape. This insight drives our approach
                to web development, where we combine clean, modern design with
                performance optimization and strategic SEO implementation.
              </p>
              <p>
                Our mission is simple: to create websites that don't just look
                impressive—they perform. Whether you're launching a new digital
                presence or upgrading an existing site, we bring the technical
                expertise and business acumen to help your brand succeed online.
              </p>
        ...
        {/* Core Values */}
        <div className="mb-20">
          <h3 className="text-2xl font-bold text-center mb-10 font-poppins">
            Core Values
          </h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-slate-900/50 rounded-2xl p-8 md:p-12 border border-slate-700">
            <div className="text-center">
              ...
              />
              <h4 className="text-xl font-bold text-orange-500 font-poppins">
                Charles Gaitz
              </h4>
