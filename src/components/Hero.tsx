      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
            Empowering businesses with modern, results-driven websites using
            elite development practices, AI-enhanced workflows, and personalized
            SEO strategies—built to perform, scale, and convert from day one.
          </p>
