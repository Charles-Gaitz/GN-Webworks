      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Ready to transform your digital presence? Whether you're launching a new site or
            upgrading an existing one, let's create something extraordinary together.
          </p>
        </div>
          ...
          <div className="bg-slate-800/50 rounded-2xl p-8 border border-slate-700">
            ...
            {user && (
              <div className="mb-6 p-4 bg-green-500/20 border border-green-500/50 rounded-lg">
                <p className="text-green-300 text-sm">✓ Signed in as {user.email}</p>
              </div>
            )}
          ...
          <div className="space-y-8">
            ...
            <div className="bg-slate-800/50 rounded-2xl p-8 border border-slate-700">
              ...
              <p className="text-gray-300">
                I typically respond to all inquiries within 24 hours. For urgent projects, feel free
                to call directly.
              </p>
            </div>
          </div>
