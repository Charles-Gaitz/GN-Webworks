        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Empowering businesses with modern, results-driven websites using elite development
              practices, AI-enhanced workflows, and personalized SEO strategies.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li>
                <a href="#process" className="hover:text-orange-500 transition-colors">
                  Process
                </a>
              </li>
              <li>
